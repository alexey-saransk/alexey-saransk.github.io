 ...
 */
function multitoggles(){var e=e||{};function t(t){this.node=t}e={attrToggle:e.attrToggle||"data-multitoggle",attrBlur:e.attrBlur||"data-multitoggle-blur",attrIsolate:e.attrIsolate||"data-multitoggle-isolate"},t.prototype.init=function(){this.selectorTarget=this.node.getAttribute(e.attrToggle),this.selectorGroup="["+e.attrToggle+'="'+this.selectorTarget+'"]',this.selectorBlur=this.node.getAttribute(e.attrBlur),this.isolate=this.node.hasAttribute(e.attrIsolate),this.nodesTarget=document.querySelectorAll(this.selectorTarget),this.nodesGroup=document.querySelectorAll(this.selectorGroup),this.nodesBlur=document.querySelectorAll(this.selectorBlur),this.nodesIsolate=document.querySelectorAll("["+e.attrIsolate+"]")},t.prototype.checkBlurContain=function(t){for(var e=!1,o=0;o<this.nodesBlur.length;o++)e=this.nodesBlur[o].contains(t)||e;return e},t.prototype.checkToggleTarget=function(t){return!t.hasAttribute(e.attrToggle)||this.selectorTarget===t.getAttribute(e.attrToggle)};for(var o=document.querySelectorAll("["+e.attrToggle+"]"),r=[],l=0;l<o.length;l++){var s=new t(o[l]);s.init(),r.push(s)}for(l=0;l<r.length;l++)r[l].node.addEventListener("click",function(e){return function(){for(var t=0;t<e.nodesTarget.length;t++)e.nodesTarget[t].classList.toggle("active");for(t=0;t<e.nodesGroup.length;t++)e.nodesGroup[t].classList.toggle("active")}}(r[l])),document.addEventListener("click",function(e){return function(){if(e.selectorBlur&&!e.checkBlurContain(event.target)){for(var t=0;t<e.nodesTarget.length;t++)e.nodesTarget[t].classList.remove("active");for(t=0;t<e.nodesGroup.length;t++)e.nodesGroup[t].classList.remove("active")}if(e.isolate&&!e.checkToggleTarget(event.target)){for(t=0;t<e.nodesTarget.length;t++)e.nodesTarget[t].classList.remove("active");for(t=0;t<e.nodesGroup.length;t++)e.nodesGroup[t].classList.remove("active")}}}(r[l]))}